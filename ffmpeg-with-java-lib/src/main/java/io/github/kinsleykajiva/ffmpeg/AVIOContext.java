...
public class AVIOContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("buffer"),
        ffmpeg_includes_h.C_INT.withName("buffer_size"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("buf_ptr"),
        ffmpeg_includes_h.C_POINTER.withName("buf_end"),
        ffmpeg_includes_h.C_POINTER.withName("opaque"),
        ffmpeg_includes_h.C_POINTER.withName("read_packet"),
        ffmpeg_includes_h.C_POINTER.withName("write_packet"),
        ffmpeg_includes_h.C_POINTER.withName("seek"),
        ffmpeg_includes_h.C_LONG_LONG.withName("pos"),
        ffmpeg_includes_h.C_INT.withName("eof_reached"),
        ffmpeg_includes_h.C_INT.withName("error"),
        ffmpeg_includes_h.C_INT.withName("write_flag"),
        ffmpeg_includes_h.C_INT.withName("max_packet_size"),
        ffmpeg_includes_h.C_INT.withName("min_packet_size"),
        ffmpeg_includes_h.C_LONG.withName("checksum"),
        ffmpeg_includes_h.C_POINTER.withName("checksum_ptr"),
        ffmpeg_includes_h.C_POINTER.withName("update_checksum"),
        ffmpeg_includes_h.C_POINTER.withName("read_pause"),
        ffmpeg_includes_h.C_POINTER.withName("read_seek"),
        ffmpeg_includes_h.C_INT.withName("seekable"),
        ffmpeg_includes_h.C_INT.withName("direct"),
        ffmpeg_includes_h.C_POINTER.withName("protocol_whitelist"),
        ffmpeg_includes_h.C_POINTER.withName("protocol_blacklist"),
        ffmpeg_includes_h.C_POINTER.withName("write_data_type"),
        ffmpeg_includes_h.C_INT.withName("ignore_boundary_point"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("buf_ptr_max"),
        ffmpeg_includes_h.C_LONG_LONG.withName("bytes_read"),
        ffmpeg_includes_h.C_LONG_LONG.withName("bytes_written")
    ...
    public final static class read_packet {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(read_packet.Function.class, "apply", $DESC);
    ...
    public final static class write_packet {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(write_packet.Function.class, "apply", $DESC);
    ...
    public final static class seek {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(seek.Function.class, "apply", $DESC);
    ...
    public final static class update_checksum {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(update_checksum.Function.class, "apply", $DESC);
    ...
    public final static class read_pause {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(read_pause.Function.class, "apply", $DESC);
    ...
    public final static class read_seek {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(read_seek.Function.class, "apply", $DESC);
    ...
    public final static class write_data_type {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(write_data_type.Function.class, "apply", $DESC);
