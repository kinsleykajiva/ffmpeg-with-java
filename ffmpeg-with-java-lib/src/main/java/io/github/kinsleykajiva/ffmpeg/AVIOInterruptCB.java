...
public class AVIOInterruptCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("callback"),
    ...
    public final static class callback {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(callback.Function.class, "apply", $DESC);
