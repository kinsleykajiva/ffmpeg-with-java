...
public class AVHWFramesContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("device_ref"),
        ffmpeg_includes_h.C_POINTER.withName("device_ctx"),
        ffmpeg_includes_h.C_POINTER.withName("hwctx"),
        ffmpeg_includes_h.C_POINTER.withName("free"),
        ffmpeg_includes_h.C_POINTER.withName("user_opaque"),
        ffmpeg_includes_h.C_POINTER.withName("pool"),
        ffmpeg_includes_h.C_INT.withName("initial_pool_size"),
        ffmpeg_includes_h.C_INT.withName("format"),
        ffmpeg_includes_h.C_INT.withName("sw_format"),
    ...
    public final static class free {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(free.Function.class, "apply", $DESC);
