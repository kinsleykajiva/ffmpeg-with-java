...
public class SwsFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("lumH"),
        ffmpeg_includes_h.C_POINTER.withName("lumV"),
        ffmpeg_includes_h.C_POINTER.withName("chrH"),
        ffmpeg_includes_h.C_POINTER.withName("chrV")
    ).withName("SwsFilter");
