...
public class AVCodecContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("av_class"),
        ffmpeg_includes_h.C_INT.withName("log_level_offset"),
        ffmpeg_includes_h.C_INT.withName("codec_type"),
        ffmpeg_includes_h.C_POINTER.withName("codec"),
        ffmpeg_includes_h.C_INT.withName("codec_id"),
        ffmpeg_includes_h.C_INT.withName("codec_tag"),
        ffmpeg_includes_h.C_POINTER.withName("priv_data"),
        ffmpeg_includes_h.C_POINTER.withName("internal"),
        ffmpeg_includes_h.C_POINTER.withName("opaque"),
        ffmpeg_includes_h.C_LONG_LONG.withName("bit_rate"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        ffmpeg_includes_h.C_INT.withName("flags2"),
        ffmpeg_includes_h.C_POINTER.withName("extradata"),
        ffmpeg_includes_h.C_INT.withName("extradata_size"),
        AVRational.layout().withName("time_base"),
        AVRational.layout().withName("pkt_timebase"),
        AVRational.layout().withName("framerate"),
        ffmpeg_includes_h.C_INT.withName("delay"),
        ffmpeg_includes_h.C_INT.withName("width"),
        ffmpeg_includes_h.C_INT.withName("height"),
        ffmpeg_includes_h.C_INT.withName("coded_width"),
        ffmpeg_includes_h.C_INT.withName("coded_height"),
        AVRational.layout().withName("sample_aspect_ratio"),
        ffmpeg_includes_h.C_INT.withName("pix_fmt"),
        ffmpeg_includes_h.C_INT.withName("sw_pix_fmt"),
        ffmpeg_includes_h.C_INT.withName("color_primaries"),
        ffmpeg_includes_h.C_INT.withName("color_trc"),
        ffmpeg_includes_h.C_INT.withName("colorspace"),
        ffmpeg_includes_h.C_INT.withName("color_range"),
        ffmpeg_includes_h.C_INT.withName("chroma_sample_location"),
        ffmpeg_includes_h.C_INT.withName("field_order"),
        ffmpeg_includes_h.C_INT.withName("refs"),
        ffmpeg_includes_h.C_INT.withName("has_b_frames"),
        ffmpeg_includes_h.C_INT.withName("slice_flags"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("draw_horiz_band"),
        ffmpeg_includes_h.C_POINTER.withName("get_format"),
        ffmpeg_includes_h.C_INT.withName("max_b_frames"),
        ffmpeg_includes_h.C_FLOAT.withName("b_quant_factor"),
        ffmpeg_includes_h.C_FLOAT.withName("b_quant_offset"),
        ffmpeg_includes_h.C_FLOAT.withName("i_quant_factor"),
        ffmpeg_includes_h.C_FLOAT.withName("i_quant_offset"),
        ffmpeg_includes_h.C_FLOAT.withName("lumi_masking"),
        ffmpeg_includes_h.C_FLOAT.withName("temporal_cplx_masking"),
        ffmpeg_includes_h.C_FLOAT.withName("spatial_cplx_masking"),
        ffmpeg_includes_h.C_FLOAT.withName("p_masking"),
        ffmpeg_includes_h.C_FLOAT.withName("dark_masking"),
        ffmpeg_includes_h.C_INT.withName("nsse_weight"),
        ffmpeg_includes_h.C_INT.withName("me_cmp"),
        ffmpeg_includes_h.C_INT.withName("me_sub_cmp"),
        ffmpeg_includes_h.C_INT.withName("mb_cmp"),
        ffmpeg_includes_h.C_INT.withName("ildct_cmp"),
        ffmpeg_includes_h.C_INT.withName("dia_size"),
        ffmpeg_includes_h.C_INT.withName("last_predictor_count"),
        ffmpeg_includes_h.C_INT.withName("me_pre_cmp"),
        ffmpeg_includes_h.C_INT.withName("pre_dia_size"),
        ffmpeg_includes_h.C_INT.withName("me_subpel_quality"),
        ffmpeg_includes_h.C_INT.withName("me_range"),
        ffmpeg_includes_h.C_INT.withName("mb_decision"),
        ffmpeg_includes_h.C_POINTER.withName("intra_matrix"),
        ffmpeg_includes_h.C_POINTER.withName("inter_matrix"),
        ffmpeg_includes_h.C_POINTER.withName("chroma_intra_matrix"),
        ffmpeg_includes_h.C_INT.withName("intra_dc_precision"),
        ffmpeg_includes_h.C_INT.withName("mb_lmin"),
        ffmpeg_includes_h.C_INT.withName("mb_lmax"),
        ffmpeg_includes_h.C_INT.withName("bidir_refine"),
        ffmpeg_includes_h.C_INT.withName("keyint_min"),
        ffmpeg_includes_h.C_INT.withName("gop_size"),
        ffmpeg_includes_h.C_INT.withName("mv0_threshold"),
        ffmpeg_includes_h.C_INT.withName("slices"),
        ffmpeg_includes_h.C_INT.withName("sample_rate"),
        ffmpeg_includes_h.C_INT.withName("sample_fmt"),
        AVChannelLayout.layout().withName("ch_layout"),
        ffmpeg_includes_h.C_INT.withName("frame_size"),
        ffmpeg_includes_h.C_INT.withName("block_align"),
        ffmpeg_includes_h.C_INT.withName("cutoff"),
        ffmpeg_includes_h.C_INT.withName("audio_service_type"),
        ffmpeg_includes_h.C_INT.withName("request_sample_fmt"),
        ffmpeg_includes_h.C_INT.withName("initial_padding"),
        ffmpeg_includes_h.C_INT.withName("trailing_padding"),
        ffmpeg_includes_h.C_INT.withName("seek_preroll"),
        ffmpeg_includes_h.C_POINTER.withName("get_buffer2"),
        ffmpeg_includes_h.C_INT.withName("bit_rate_tolerance"),
        ffmpeg_includes_h.C_INT.withName("global_quality"),
        ffmpeg_includes_h.C_INT.withName("compression_level"),
        ffmpeg_includes_h.C_FLOAT.withName("qcompress"),
        ffmpeg_includes_h.C_FLOAT.withName("qblur"),
        ffmpeg_includes_h.C_INT.withName("qmin"),
        ffmpeg_includes_h.C_INT.withName("qmax"),
        ffmpeg_includes_h.C_INT.withName("max_qdiff"),
        ffmpeg_includes_h.C_INT.withName("rc_buffer_size"),
        ffmpeg_includes_h.C_INT.withName("rc_override_count"),
        ffmpeg_includes_h.C_POINTER.withName("rc_override"),
        ffmpeg_includes_h.C_LONG_LONG.withName("rc_max_rate"),
        ffmpeg_includes_h.C_LONG_LONG.withName("rc_min_rate"),
        ffmpeg_includes_h.C_FLOAT.withName("rc_max_available_vbv_use"),
        ffmpeg_includes_h.C_FLOAT.withName("rc_min_vbv_overflow_use"),
        ffmpeg_includes_h.C_INT.withName("rc_initial_buffer_occupancy"),
        ffmpeg_includes_h.C_INT.withName("trellis"),
        ffmpeg_includes_h.C_POINTER.withName("stats_out"),
        ffmpeg_includes_h.C_POINTER.withName("stats_in"),
        ffmpeg_includes_h.C_INT.withName("workaround_bugs"),
        ffmpeg_includes_h.C_INT.withName("strict_std_compliance"),
        ffmpeg_includes_h.C_INT.withName("error_concealment"),
        ffmpeg_includes_h.C_INT.withName("debug"),
        ffmpeg_includes_h.C_INT.withName("err_recognition"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("hwaccel"),
        ffmpeg_includes_h.C_POINTER.withName("hwaccel_context"),
        ffmpeg_includes_h.C_POINTER.withName("hw_frames_ctx"),
        ffmpeg_includes_h.C_POINTER.withName("hw_device_ctx"),
        ffmpeg_includes_h.C_INT.withName("hwaccel_flags"),
        ffmpeg_includes_h.C_INT.withName("extra_hw_frames"),
        MemoryLayout.sequenceLayout(8, ffmpeg_includes_h.C_LONG_LONG).withName("error"),
        ffmpeg_includes_h.C_INT.withName("dct_algo"),
        ffmpeg_includes_h.C_INT.withName("idct_algo"),
        ffmpeg_includes_h.C_INT.withName("bits_per_coded_sample"),
        ffmpeg_includes_h.C_INT.withName("bits_per_raw_sample"),
        ffmpeg_includes_h.C_INT.withName("thread_count"),
        ffmpeg_includes_h.C_INT.withName("thread_type"),
        ffmpeg_includes_h.C_INT.withName("active_thread_type"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("execute"),
        ffmpeg_includes_h.C_POINTER.withName("execute2"),
        ffmpeg_includes_h.C_INT.withName("profile"),
        ffmpeg_includes_h.C_INT.withName("level"),
        ffmpeg_includes_h.C_INT.withName("properties"),
        ffmpeg_includes_h.C_INT.withName("skip_loop_filter"),
        ffmpeg_includes_h.C_INT.withName("skip_idct"),
        ffmpeg_includes_h.C_INT.withName("skip_frame"),
        ffmpeg_includes_h.C_INT.withName("skip_alpha"),
        ffmpeg_includes_h.C_INT.withName("skip_top"),
        ffmpeg_includes_h.C_INT.withName("skip_bottom"),
        ffmpeg_includes_h.C_INT.withName("lowres"),
        ffmpeg_includes_h.C_POINTER.withName("codec_descriptor"),
        ffmpeg_includes_h.C_POINTER.withName("sub_charenc"),
        ffmpeg_includes_h.C_INT.withName("sub_charenc_mode"),
        ffmpeg_includes_h.C_INT.withName("subtitle_header_size"),
        ffmpeg_includes_h.C_POINTER.withName("subtitle_header"),
        ffmpeg_includes_h.C_POINTER.withName("dump_separator"),
        ffmpeg_includes_h.C_POINTER.withName("codec_whitelist"),
        ffmpeg_includes_h.C_POINTER.withName("coded_side_data"),
        ffmpeg_includes_h.C_INT.withName("nb_coded_side_data"),
        ffmpeg_includes_h.C_INT.withName("export_side_data"),
        ffmpeg_includes_h.C_LONG_LONG.withName("max_pixels"),
        ffmpeg_includes_h.C_INT.withName("apply_cropping"),
        ffmpeg_includes_h.C_INT.withName("discard_damaged_percentage"),
        ffmpeg_includes_h.C_LONG_LONG.withName("max_samples"),
        ffmpeg_includes_h.C_POINTER.withName("get_encode_buffer"),
        ffmpeg_includes_h.C_LONG_LONG.withName("frame_num"),
        ffmpeg_includes_h.C_POINTER.withName("side_data_prefer_packet"),
        ffmpeg_includes_h.C_INT.withName("nb_side_data_prefer_packet"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("decoded_side_data"),
        ffmpeg_includes_h.C_INT.withName("nb_decoded_side_data"),
        ffmpeg_includes_h.C_INT.withName("alpha_mode")
    ...
    public final static class draw_horiz_band {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(draw_horiz_band.Function.class, "apply", $DESC);
    ...
    public final static class get_format {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(get_format.Function.class, "apply", $DESC);
    ...
    public final static class get_buffer2 {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(get_buffer2.Function.class, "apply", $DESC);
    ...
    public final static class execute {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(execute.Function.class, "apply", $DESC);
    ...
    public final static class execute2 {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(execute2.Function.class, "apply", $DESC);
    ...
    public final static class get_encode_buffer {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(get_encode_buffer.Function.class, "apply", $DESC);
