...
public class __crt_locale_data_public {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("_locale_pctype"),
        ffmpeg_includes_h.C_INT.withName("_locale_mb_cur_max"),
        ffmpeg_includes_h.C_INT.withName("_locale_lc_codepage")
