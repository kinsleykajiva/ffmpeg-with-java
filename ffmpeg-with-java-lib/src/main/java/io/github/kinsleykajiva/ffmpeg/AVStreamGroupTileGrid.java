...
public class AVStreamGroupTileGrid {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_INT.withName("nb_tiles"),
        ffmpeg_includes_h.C_INT.withName("coded_width"),
        ffmpeg_includes_h.C_INT.withName("coded_height"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("offsets"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_CHAR).withName("background"),
        ffmpeg_includes_h.C_INT.withName("horizontal_offset"),
        ffmpeg_includes_h.C_INT.withName("vertical_offset"),
    ...
    public static class offsets {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ffmpeg_includes_h.C_INT.withName("idx"),
            ffmpeg_includes_h.C_INT.withName("horizontal"),
            ffmpeg_includes_h.C_INT.withName("vertical")
        ).withName("$anon$986:5");
