...
public class AVRegionOfInterest {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("self_size"),
        ffmpeg_includes_h.C_INT.withName("top"),
        ffmpeg_includes_h.C_INT.withName("bottom"),
        ffmpeg_includes_h.C_INT.withName("left"),
        ffmpeg_includes_h.C_INT.withName("right"),
