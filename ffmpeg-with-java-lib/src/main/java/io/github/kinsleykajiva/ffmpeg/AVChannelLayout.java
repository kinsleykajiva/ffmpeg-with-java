...
public class AVChannelLayout {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("order"),
        ffmpeg_includes_h.C_INT.withName("nb_channels"),
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ffmpeg_includes_h.C_LONG_LONG.withName("mask"),
            ffmpeg_includes_h.C_POINTER.withName("map")
        ).withName("$anon$336:5");
