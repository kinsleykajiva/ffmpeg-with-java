...
public class AVPacket {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("buf"),
        ffmpeg_includes_h.C_LONG_LONG.withName("pts"),
        ffmpeg_includes_h.C_LONG_LONG.withName("dts"),
        ffmpeg_includes_h.C_POINTER.withName("data"),
        ffmpeg_includes_h.C_INT.withName("size"),
        ffmpeg_includes_h.C_INT.withName("stream_index"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("side_data"),
        ffmpeg_includes_h.C_INT.withName("side_data_elems"),
        MemoryLayout.paddingLayout(4),
