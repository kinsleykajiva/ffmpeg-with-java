...
public class AVFormatContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("iformat"),
        ffmpeg_includes_h.C_POINTER.withName("oformat"),
        ffmpeg_includes_h.C_POINTER.withName("priv_data"),
        ffmpeg_includes_h.C_POINTER.withName("pb"),
        ffmpeg_includes_h.C_INT.withName("ctx_flags"),
        ffmpeg_includes_h.C_INT.withName("nb_streams"),
        ffmpeg_includes_h.C_POINTER.withName("streams"),
        ffmpeg_includes_h.C_INT.withName("nb_stream_groups"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("stream_groups"),
        ffmpeg_includes_h.C_INT.withName("nb_chapters"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("chapters"),
        ffmpeg_includes_h.C_POINTER.withName("url"),
        ffmpeg_includes_h.C_LONG_LONG.withName("start_time"),
        ffmpeg_includes_h.C_LONG_LONG.withName("duration"),
        ffmpeg_includes_h.C_LONG_LONG.withName("bit_rate"),
        ffmpeg_includes_h.C_INT.withName("packet_size"),
        ffmpeg_includes_h.C_INT.withName("max_delay"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_LONG_LONG.withName("probesize"),
        ffmpeg_includes_h.C_LONG_LONG.withName("max_analyze_duration"),
        ffmpeg_includes_h.C_POINTER.withName("key"),
        ffmpeg_includes_h.C_INT.withName("keylen"),
        ffmpeg_includes_h.C_INT.withName("nb_programs"),
        ffmpeg_includes_h.C_POINTER.withName("programs"),
        ffmpeg_includes_h.C_INT.withName("video_codec_id"),
        ffmpeg_includes_h.C_INT.withName("audio_codec_id"),
        ffmpeg_includes_h.C_INT.withName("subtitle_codec_id"),
        ffmpeg_includes_h.C_INT.withName("data_codec_id"),
        ffmpeg_includes_h.C_POINTER.withName("metadata"),
        ffmpeg_includes_h.C_LONG_LONG.withName("start_time_realtime"),
        ffmpeg_includes_h.C_INT.withName("fps_probe_size"),
        ffmpeg_includes_h.C_INT.withName("error_recognition"),
        AVIOInterruptCB.layout().withName("interrupt_callback"),
        ffmpeg_includes_h.C_INT.withName("debug"),
        ffmpeg_includes_h.C_INT.withName("max_streams"),
        ffmpeg_includes_h.C_INT.withName("max_index_size"),
        ffmpeg_includes_h.C_INT.withName("max_picture_buffer"),
        ffmpeg_includes_h.C_LONG_LONG.withName("max_interleave_delta"),
        ffmpeg_includes_h.C_INT.withName("max_ts_probe"),
        ffmpeg_includes_h.C_INT.withName("max_chunk_duration"),
        ffmpeg_includes_h.C_INT.withName("max_chunk_size"),
        ffmpeg_includes_h.C_INT.withName("max_probe_packets"),
        ffmpeg_includes_h.C_INT.withName("strict_std_compliance"),
        ffmpeg_includes_h.C_INT.withName("event_flags"),
        ffmpeg_includes_h.C_INT.withName("avoid_negative_ts"),
        ffmpeg_includes_h.C_INT.withName("audio_preload"),
        ffmpeg_includes_h.C_INT.withName("use_wallclock_as_timestamps"),
        ffmpeg_includes_h.C_INT.withName("skip_estimate_duration_from_pts"),
        ffmpeg_includes_h.C_INT.withName("avio_flags"),
        ffmpeg_includes_h.C_INT.withName("duration_estimation_method"),
        ffmpeg_includes_h.C_LONG_LONG.withName("skip_initial_bytes"),
        ffmpeg_includes_h.C_INT.withName("correct_ts_overflow"),
        ffmpeg_includes_h.C_INT.withName("seek2any"),
        ffmpeg_includes_h.C_INT.withName("flush_packets"),
        ffmpeg_includes_h.C_INT.withName("probe_score"),
        ffmpeg_includes_h.C_INT.withName("format_probesize"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("codec_whitelist"),
        ffmpeg_includes_h.C_POINTER.withName("format_whitelist"),
        ffmpeg_includes_h.C_POINTER.withName("protocol_whitelist"),
        ffmpeg_includes_h.C_POINTER.withName("protocol_blacklist"),
        ffmpeg_includes_h.C_INT.withName("io_repositioned"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("video_codec"),
        ffmpeg_includes_h.C_POINTER.withName("audio_codec"),
        ffmpeg_includes_h.C_POINTER.withName("subtitle_codec"),
        ffmpeg_includes_h.C_POINTER.withName("data_codec"),
        ffmpeg_includes_h.C_INT.withName("metadata_header_padding"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("opaque"),
        ffmpeg_includes_h.C_POINTER.withName("control_message_cb"),
        ffmpeg_includes_h.C_LONG_LONG.withName("output_ts_offset"),
        ffmpeg_includes_h.C_POINTER.withName("dump_separator"),
        ffmpeg_includes_h.C_POINTER.withName("io_open"),
        ffmpeg_includes_h.C_POINTER.withName("io_close2"),
        ffmpeg_includes_h.C_LONG_LONG.withName("duration_probesize"),
        ffmpeg_includes_h.C_POINTER.withName("name")
    ...
    public final static class io_open {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(io_open.Function.class, "apply", $DESC);
    ...
    public final static class io_close2 {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(io_close2.Function.class, "apply", $DESC);
