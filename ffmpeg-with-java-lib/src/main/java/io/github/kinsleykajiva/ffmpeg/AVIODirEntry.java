...
public class AVIODirEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_INT.withName("utf8"),
        ffmpeg_includes_h.C_LONG_LONG.withName("size"),
        ffmpeg_includes_h.C_LONG_LONG.withName("modification_timestamp"),
        ffmpeg_includes_h.C_LONG_LONG.withName("access_timestamp"),
        ffmpeg_includes_h.C_LONG_LONG.withName("status_change_timestamp"),
        ffmpeg_includes_h.C_LONG_LONG.withName("user_id"),
        ffmpeg_includes_h.C_LONG_LONG.withName("group_id"),
        ffmpeg_includes_h.C_LONG_LONG.withName("filemode")
