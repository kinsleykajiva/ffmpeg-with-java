...
public class AVSubtitleRect {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("x"),
        ffmpeg_includes_h.C_INT.withName("y"),
        ffmpeg_includes_h.C_INT.withName("w"),
        ffmpeg_includes_h.C_INT.withName("h"),
        ffmpeg_includes_h.C_INT.withName("nb_colors"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_POINTER).withName("data"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_INT).withName("linesize"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        ffmpeg_includes_h.C_INT.withName("type"),
        ffmpeg_includes_h.C_POINTER.withName("text"),
        ffmpeg_includes_h.C_POINTER.withName("ass")
