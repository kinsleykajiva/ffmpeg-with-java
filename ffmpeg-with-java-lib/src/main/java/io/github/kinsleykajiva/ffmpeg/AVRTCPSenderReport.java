...
public class AVRTCPSenderReport {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("ssrc"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_LONG_LONG.withName("ntp_timestamp"),
        ffmpeg_includes_h.C_INT.withName("rtp_timestamp"),
        ffmpeg_includes_h.C_INT.withName("sender_nb_packets"),
        ffmpeg_includes_h.C_INT.withName("sender_nb_bytes"),
        MemoryLayout.paddingLayout(4)
