...
public class AVOutputFormat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("mime_type"),
        ffmpeg_includes_h.C_POINTER.withName("extensions"),
        ffmpeg_includes_h.C_INT.withName("audio_codec"),
        ffmpeg_includes_h.C_INT.withName("video_codec"),
        ffmpeg_includes_h.C_INT.withName("subtitle_codec"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        ffmpeg_includes_h.C_POINTER.withName("codec_tag"),
