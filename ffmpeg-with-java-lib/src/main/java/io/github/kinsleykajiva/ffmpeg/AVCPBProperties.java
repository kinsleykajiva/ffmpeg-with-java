...
public class AVCPBProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_LONG_LONG.withName("max_bitrate"),
        ffmpeg_includes_h.C_LONG_LONG.withName("min_bitrate"),
        ffmpeg_includes_h.C_LONG_LONG.withName("avg_bitrate"),
        ffmpeg_includes_h.C_LONG_LONG.withName("buffer_size"),
        ffmpeg_includes_h.C_LONG_LONG.withName("vbv_delay")
