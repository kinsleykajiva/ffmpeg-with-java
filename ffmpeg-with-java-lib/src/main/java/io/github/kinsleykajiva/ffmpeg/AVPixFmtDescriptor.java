...
public class AVPixFmtDescriptor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_CHAR.withName("nb_components"),
        ffmpeg_includes_h.C_CHAR.withName("log2_chroma_w"),
        ffmpeg_includes_h.C_CHAR.withName("log2_chroma_h"),
        MemoryLayout.paddingLayout(5),
        ffmpeg_includes_h.C_LONG_LONG.withName("flags"),
        MemoryLayout.sequenceLayout(4, AVComponentDescriptor.layout()).withName("comp"),
        ffmpeg_includes_h.C_POINTER.withName("alias")
