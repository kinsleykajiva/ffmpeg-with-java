...
public class AVComponentDescriptor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("plane"),
        ffmpeg_includes_h.C_INT.withName("step"),
        ffmpeg_includes_h.C_INT.withName("offset"),
        ffmpeg_includes_h.C_INT.withName("shift"),
        ffmpeg_includes_h.C_INT.withName("depth")
