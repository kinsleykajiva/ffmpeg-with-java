...
public class AVFrame {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, ffmpeg_includes_h.C_POINTER).withName("data"),
        MemoryLayout.sequenceLayout(8, ffmpeg_includes_h.C_INT).withName("linesize"),
        ffmpeg_includes_h.C_POINTER.withName("extended_data"),
        ffmpeg_includes_h.C_INT.withName("width"),
        ffmpeg_includes_h.C_INT.withName("height"),
        ffmpeg_includes_h.C_INT.withName("nb_samples"),
        ...
        ffmpeg_includes_h.C_LONG_LONG.withName("pkt_dts"),
        AVRational.layout().withName("time_base"),
        ffmpeg_includes_h.C_INT.withName("quality"),
        MemoryLayout.paddingLayout(4),
        ...
        MemoryLayout.sequenceLayout(8, ffmpeg_includes_h.C_POINTER).withName("buf"),
        ffmpeg_includes_h.C_POINTER.withName("extended_buf"),
        ffmpeg_includes_h.C_INT.withName("nb_extended_buf"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("side_data"),
        ffmpeg_includes_h.C_INT.withName("nb_side_data"),
        ...
        ffmpeg_includes_h.C_INT.withName("chroma_location"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_LONG_LONG.withName("best_effort_timestamp"),
        ffmpeg_includes_h.C_POINTER.withName("metadata"),
        ffmpeg_includes_h.C_INT.withName("decode_error_flags"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("hw_frames_ctx"),
        ffmpeg_includes_h.C_POINTER.withName("opaque_ref"),
        ffmpeg_includes_h.C_LONG_LONG.withName("crop_top"),
        ffmpeg_includes_h.C_LONG_LONG.withName("crop_bottom"),
        ffmpeg_includes_h.C_LONG_LONG.withName("crop_left"),
        ffmpeg_includes_h.C_LONG_LONG.withName("crop_right"),
        ffmpeg_includes_h.C_POINTER.withName("private_ref"),
