...
public class AVHWFramesConstraints {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("valid_hw_formats"),
        ffmpeg_includes_h.C_POINTER.withName("valid_sw_formats"),
        ffmpeg_includes_h.C_INT.withName("min_width"),
        ffmpeg_includes_h.C_INT.withName("min_height"),
        ffmpeg_includes_h.C_INT.withName("max_width"),
        ffmpeg_includes_h.C_INT.withName("max_height")
