...
public class AVCodec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("long_name"),
        ffmpeg_includes_h.C_INT.withName("type"),
        ffmpeg_includes_h.C_INT.withName("id"),
        ffmpeg_includes_h.C_INT.withName("capabilities"),
        ffmpeg_includes_h.C_CHAR.withName("max_lowres"),
        MemoryLayout.paddingLayout(3),
        ffmpeg_includes_h.C_POINTER.withName("supported_framerates"),
        ffmpeg_includes_h.C_POINTER.withName("pix_fmts"),
        ffmpeg_includes_h.C_POINTER.withName("supported_samplerates"),
        ffmpeg_includes_h.C_POINTER.withName("sample_fmts"),
        ffmpeg_includes_h.C_POINTER.withName("priv_class"),
        ffmpeg_includes_h.C_POINTER.withName("profiles"),
        ffmpeg_includes_h.C_POINTER.withName("wrapper_name"),
        ffmpeg_includes_h.C_POINTER.withName("ch_layouts")
    ).withName("AVCodec");
