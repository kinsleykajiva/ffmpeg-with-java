...
public class SwsContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, ffmpeg_includes_h.C_DOUBLE).withName("scaler_params"),
        ffmpeg_includes_h.C_INT.withName("threads"),
        ffmpeg_includes_h.C_INT.withName("dither"),
        ffmpeg_includes_h.C_INT.withName("alpha_blend"),
        ffmpeg_includes_h.C_INT.withName("gamma_flag"),
        ffmpeg_includes_h.C_INT.withName("src_w"),
        ffmpeg_includes_h.C_INT.withName("src_h"),
        ffmpeg_includes_h.C_INT.withName("dst_w"),
        ffmpeg_includes_h.C_INT.withName("dst_h"),
        ffmpeg_includes_h.C_INT.withName("src_format"),
        ffmpeg_includes_h.C_INT.withName("dst_format"),
        ffmpeg_includes_h.C_INT.withName("src_range"),
        ffmpeg_includes_h.C_INT.withName("dst_range"),
        ffmpeg_includes_h.C_INT.withName("src_v_chr_pos"),
        ffmpeg_includes_h.C_INT.withName("src_h_chr_pos"),
        ffmpeg_includes_h.C_INT.withName("dst_v_chr_pos"),
        ffmpeg_includes_h.C_INT.withName("dst_h_chr_pos"),
        ffmpeg_includes_h.C_INT.withName("intent"),
        MemoryLayout.paddingLayout(4)
    ).withName("SwsContext");
