...
public class AVCodecParserContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_POINTER.withName("parser"),
        ffmpeg_includes_h.C_LONG_LONG.withName("frame_offset"),
        ffmpeg_includes_h.C_LONG_LONG.withName("cur_offset"),
        ffmpeg_includes_h.C_LONG_LONG.withName("next_frame_offset"),
        ffmpeg_includes_h.C_INT.withName("pict_type"),
        ffmpeg_includes_h.C_INT.withName("repeat_pict"),
        ffmpeg_includes_h.C_LONG_LONG.withName("pts"),
        ffmpeg_includes_h.C_LONG_LONG.withName("dts"),
        ffmpeg_includes_h.C_LONG_LONG.withName("last_pts"),
        ffmpeg_includes_h.C_LONG_LONG.withName("last_dts"),
        ffmpeg_includes_h.C_INT.withName("fetch_timestamp"),
        ffmpeg_includes_h.C_INT.withName("cur_frame_start_index"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_LONG_LONG).withName("cur_frame_offset"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_LONG_LONG).withName("cur_frame_pts"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_LONG_LONG).withName("cur_frame_dts"),
        ffmpeg_includes_h.C_INT.withName("flags"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_LONG_LONG.withName("offset"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_LONG_LONG).withName("cur_frame_end"),
        ffmpeg_includes_h.C_INT.withName("key_frame"),
        ffmpeg_includes_h.C_INT.withName("dts_sync_point"),
        ffmpeg_includes_h.C_INT.withName("dts_ref_dts_delta"),
        ffmpeg_includes_h.C_INT.withName("pts_dts_delta"),
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_LONG_LONG).withName("cur_frame_pos"),
        ffmpeg_includes_h.C_LONG_LONG.withName("pos"),
        ffmpeg_includes_h.C_LONG_LONG.withName("last_pos"),
        ffmpeg_includes_h.C_INT.withName("duration"),
        ffmpeg_includes_h.C_INT.withName("field_order"),
        ffmpeg_includes_h.C_INT.withName("picture_structure"),
        ffmpeg_includes_h.C_INT.withName("output_picture_number"),
        ...
        ffmpeg_includes_h.C_INT.withName("format"),
        MemoryLayout.paddingLayout(4)
