...
public class RcOverride {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_INT.withName("start_frame"),
        ffmpeg_includes_h.C_INT.withName("end_frame"),
        ffmpeg_includes_h.C_INT.withName("qscale"),
        ffmpeg_includes_h.C_FLOAT.withName("quality_factor")
    ).withName("RcOverride");
