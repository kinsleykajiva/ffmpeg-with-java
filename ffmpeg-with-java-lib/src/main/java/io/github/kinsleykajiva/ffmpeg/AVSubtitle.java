...
public class AVSubtitle {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_SHORT.withName("format"),
        MemoryLayout.paddingLayout(2),
        ffmpeg_includes_h.C_INT.withName("start_display_time"),
        ffmpeg_includes_h.C_INT.withName("end_display_time"),
        ffmpeg_includes_h.C_INT.withName("num_rects"),
        ffmpeg_includes_h.C_POINTER.withName("rects"),
