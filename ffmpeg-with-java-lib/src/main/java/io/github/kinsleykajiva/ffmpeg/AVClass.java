...
public class AVClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ffmpeg_includes_h.C_POINTER.withName("class_name"),
        ffmpeg_includes_h.C_POINTER.withName("item_name"),
        ffmpeg_includes_h.C_POINTER.withName("option"),
        ffmpeg_includes_h.C_INT.withName("version"),
        ffmpeg_includes_h.C_INT.withName("log_level_offset_offset"),
        ffmpeg_includes_h.C_INT.withName("parent_log_context_offset"),
        ffmpeg_includes_h.C_INT.withName("category"),
        ffmpeg_includes_h.C_POINTER.withName("get_category"),
        ffmpeg_includes_h.C_POINTER.withName("query_ranges"),
        ffmpeg_includes_h.C_POINTER.withName("child_next"),
        ffmpeg_includes_h.C_POINTER.withName("child_class_iterate"),
        ffmpeg_includes_h.C_INT.withName("state_flags_offset"),
    ...
    public final static class item_name {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(item_name.Function.class, "apply", $DESC);
    ...
    public final static class get_category {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(get_category.Function.class, "apply", $DESC);
    ...
    public final static class query_ranges {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(query_ranges.Function.class, "apply", $DESC);
    ...
    public final static class child_next {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(child_next.Function.class, "apply", $DESC);
    ...
    public final static class child_class_iterate {
        ...
        private static final MethodHandle UP$MH = ffmpeg_includes_h.upcallHandle(child_class_iterate.Function.class, "apply", $DESC);
