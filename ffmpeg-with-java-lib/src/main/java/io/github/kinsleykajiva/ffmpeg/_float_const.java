...
public class _float_const {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, ffmpeg_includes_h.C_SHORT).withName("_Word"),
        ffmpeg_includes_h.C_FLOAT.withName("_Float"),
        ffmpeg_includes_h.C_DOUBLE.withName("_Double"),
        ffmpeg_includes_h.C_LONG_DOUBLE.withName("_Long_double")
    ).withName("$anon$259:9");
