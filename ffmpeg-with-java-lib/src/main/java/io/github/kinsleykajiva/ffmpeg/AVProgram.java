...
public class AVProgram {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ffmpeg_includes_h.C_INT.withName("discard"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("stream_index"),
        ffmpeg_includes_h.C_INT.withName("nb_stream_indexes"),
        MemoryLayout.paddingLayout(4),
        ffmpeg_includes_h.C_POINTER.withName("metadata"),
        ffmpeg_includes_h.C_INT.withName("program_num"),
        ffmpeg_includes_h.C_INT.withName("pmt_pid"),
        ffmpeg_includes_h.C_INT.withName("pcr_pid"),
        ffmpeg_includes_h.C_INT.withName("pmt_version"),
        ffmpeg_includes_h.C_LONG_LONG.withName("start_time"),
        ffmpeg_includes_h.C_LONG_LONG.withName("end_time"),
        ffmpeg_includes_h.C_LONG_LONG.withName("pts_wrap_reference"),
        ffmpeg_includes_h.C_INT.withName("pts_wrap_behavior"),
        MemoryLayout.paddingLayout(4)
    ).withName("AVProgram");
